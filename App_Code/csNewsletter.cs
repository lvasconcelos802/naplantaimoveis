...
{
    public class csNewsletter
    {
        public static string criarNewsletterHtml(string id_newsletter, string id_newsletter_relatorio, string email_destino)
        {
            string html = "";
            string url = "";
            string alt = "";
            ...
            try
            {
                ...
                if (rdr1.HasRows)
                {
                    while (rdr1.Read())
                    {
                        ...
                        if (rdr1["mensagem"].ToString() != "")
                        {
                            ...
                            html = html + "<span style=\"font-size:18px;\">" + rdr1["mensagem"].ToString() + "</span>";
                            html = html + "</td>";
                            html = html + "</tr>";
                            html = html + "</table>";
                        }
                ...
                if (rdr.HasRows)
                {
                    while (rdr.Read())
                    {
                        url = classes.removerAcentos(rdr["imovel"].ToString() + "-" + rdr["sub_imovel"].ToString() + "-para-" + rdr["contrato"].ToString() + "-" + rdr["bairro"].ToString() + "-" + rdr["cidade"].ToString() + "-" + rdr["estado"].ToString() + "-" + rdr["id"].ToString()) + ".aspx?id_newsletter_relatorio=" + id_newsletter_relatorio + "";
                        ...
                        html = html + "<tr>";
                        html = html + "<td>";
                        html = html + "<a href=\"https://www.naplantaimoveis.com.br/" + url + "\" style=\"font-size:16px;\" target=\"_blank\">VER MAIS</a>";
                        html = html + "</td>";
                        html = html + "</tr>";
                        html = html + "<tr>";
                        html = html + "<td>";
                ...
                html = html + "<tr>";
                html = html + "<td style=\"text-align:center;width:320px\">";
                html = html + "<span style=\"font-size:13px;\">Deseja cancelar este e-mail? <a href=\"https://www.naplantaimoveis.com.br/newsletter_cancelar.aspx?email=" + email_destino + "\" target=\"_blank\" title=\"Facebook\" style=\"margin:2px;\">clique aqui</a></span>";
                html = html + "</td>";
                html = html + "</tr>";
                ...
                html = html + "<img width=\"1\" height=\"1\" title=\"\" alt=\"\" src=\"https://www.naplantaimoveis.com.br/newsletter_click.ashx?id="+ id_newsletter_relatorio + "\" />";
